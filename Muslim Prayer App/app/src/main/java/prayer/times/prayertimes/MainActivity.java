package prayer.times.prayertimes;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void getJSONandSetFields(String result) {
        ...
        try {
            ...
            */
            ...
            // Get the last day of the month that user chooses in CalendarView
            int lastDayOfCurrentMonth = getLastDayOfChosenMonth();
    ...
    private int getLastDayOfChosenMonth() {
        ...
        String chosenDate = getDefaults("chosenDate", getApplicationContext());

        chosenDate = chosenDate.replaceAll("-","/");

        Log.d("CHOSEN DATE", chosenDate);

        LocalDate convertedDate = LocalDate.parse(chosenDate, DateTimeFormatter.ofPattern("d/M/yyyy"));
        convertedDate = convertedDate.withDayOfMonth(convertedDate.getMonth().length(convertedDate.isLeapYear()));

        Log.d("CONVERTED DATE", String.valueOf(convertedDate));

        String lastDayDate = String.valueOf(convertedDate);
        String lastDay = lastDayDate.substring(8);

        Log.d("LAST DAAAY", lastDay);
    ...
    /**
     * @name setAppLanguage
     * @description Set the application langauge to US English. This is done in order for the
     * language in Calendar View to be English instead of the devices chosen language.
     */
    ...
    private String getApiUrl() {
        ...
        String date = getDefaults("chosenDate", getApplicationContext());
        ...
        return "http://api.aladhan.com/v1/calendarByCity?city=" + city + "&country=*&month=" + dateArr[1] + "&year=" + dateArr[2];
    }
     ...
     *                in SharedPrefs, set London as the default city until another city is chosen.
     */
    private void initializeSharedPreferences() {

        if (getDefaults("selectedCity", getApplicationContext()) == null ||
            getDefaults("chosenDate", getApplicationContext()) == null){
            setDefaults("selectedCity", "London", getApplicationContext());
            String todayDate = getTodayDate();
            setDefaults("chosenDate", todayDate, getApplicationContext());
        }
    }
